   ...
   <div>
     <el-row :gutter="24" style="margin-buttom 20px" class="total>
        <el-col :span="6">
          ...
          <el-col :span="6">
          <el-card shadow="alawys" class="on">
            <div style="float: left">
                <p>本月放款(元)</p>
                <p style="font-weight :bold">1210000</p>
                <p>
                  +1.25%
                  <span style="font-size:12px">与上月同比</span>
                </p>
...
.on{background-color:pink;}
.allin{background-color: #5050ff;}
.allout{background-color: #f49b3b;}
.total{
  p{color: aliceblue;line-height: 30px;}
  }
</style>