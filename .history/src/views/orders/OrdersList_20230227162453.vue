<template>
  ...
  <el-breadcrumb-item v-for="(item,index) in breadList" :key="index">{{item}}</el-breadcrumb-item>
   ...
   <el-card class="mt">
      ...
      <el-table-column prop="date" label="起始城市" width="180"></el-table-column>
      <el-table-column prop="name" label="目的城市" width="180"></el-table-column>
      <el-table-column prop="address" label="件数"> </el-table-column>
      <el-table-column prop="address" label="单位"> </el-table-column>
      <el-table-column prop="address" label="运费"> </el-table-column>
      <el-table-column prop="address" label="订单来源"> </el-table-column>
      <el-table-column prop="address" label="是否支付"> </el-table-column>
